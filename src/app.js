...
typeorm_1.createConnection().then(function (db) {
    amqp.connect('amqps://kfzxhqby:sD38IHf5gxMWyzAeKOwt3ctQbY2Ypny8@codfish.rmq.cloudamqp.com/kfzxhqby', function (error0, connection) {
        ...
        connection.createChannel(function (error1, channel) {
            ...
            channel.consume('company_created', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            channel.consume('company_deleted', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    channel.ack(msg);
